...
resource "azurerm_postgresql_firewall_rule" "postgres_firewall" {
  ...
  start_ip_address    = azurerm_public_ip.public_ip.ip_address#data.azurerm_public_ip.ip_data.ip_address
  end_ip_address      = azurerm_public_ip.public_ip.ip_address#data.azurerm_public_ip.ip_data.ip_address
